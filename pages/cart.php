      ...
      <section class="third-section">
        <div class="cart">
          <div class="cart-items">
            <h3 class="cart-title"><i class="fa-solid fa-cart-shopping"></i> Korzinka</h3>
            <div class="items"></div>
          </div>
          <div class="order">
            <div class="coupon">
              <h3>Vaucher bormi?</h3>
              <input type="text" placeholder="Kodingizni shu yerga kiriting">
              <button class="btn btn-warning">Qabul qilish</button>
            </div>
            <div class="subtotal"></div>
            <div>
              <h1 class="title">Sizga yoqgan tovarlar<i class="fa fa-heart"></i></h1>
