    ...
    <header>
      <nav class="flex">
        ...
        <ul class="links flex">
          ...
          <li id="login_btn"><a href="./login.php">Tizimga kirish</a></li>
        </ul>
        <div class="burger">
          <div class="line1"></div>
          <div class="line2"></div>
        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12">
            ...
            <div class="top-header">
              <h1>Tizimga kirish/Roʻyxatdan oʻtish</h1>
              <div class="top-nav">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 image-area">
            ...
            <div class="hover-text">
              <h4>Saytimizga yangimisiz?</h4>
              <p>
                Bizning a'zomiz bo'ling va barcha takliflarimiz va takliflarimizdan bahramand bo'ling. Siz ularni sog'inishni xohlamaysiz!
              </p>
              <a href="signup.php" class="login-button">Hisob ochish</a>
            </div>
          </div>
